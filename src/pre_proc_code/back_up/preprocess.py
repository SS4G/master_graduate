...
def processImage(imgFile, outputPaths):
    ...
    #加载原图
    img=cv2.imread('./imgs/test_img.jpg')
    ...
    cv2.imwrite('./imgs/071_counter.img.jpg',dilate)
    ...
    for con in contours:
        ...
        ColorLogging.debug("rect")
        ColorLogging.debug(rect)

        ColorLogging.info("box point")
        ColorLogging.info(cv2.boxPoints(rect))
